...
const ButtonClassNames = {
  primary:
    "rounded-4xl flex items-center justify-center text-gray-800 gap-2 bg-zinc-100 px-4 py-3 active:scale-102 hover:scale-102 font-medium transition-transform",
